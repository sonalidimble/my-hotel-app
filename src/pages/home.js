...
function home() {
  return (
    <div className='container mx-auto px-4'>
      <img className='object-none object-top w-[100vw] h-[50vh]' src="/hotel3.jpg"/>
  ...
  <div className="container px-5 py-24 mx-auto">
    <div className="flex flex-col text-center w-full mb-20">
      ...
      <h1 className="sm:text-3xl text-2xl font-medium title-font mb-4 text-gray-900">MY-HOTEL-APP</h1>
    ...
    <button className="flex mx-auto mt-16 text-white bg-indigo-500 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-600 rounded text-lg">View Hotels</button>
  </div>
</section>
    </div>
  )
